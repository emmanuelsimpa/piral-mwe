            ...
            for (const depName of Object.keys(sharedImports)) {
                ...
                if (typeof url !== 'string') {
                    ...
                    if (entry) {
                        ...
                        const [version, requireVersion] = yield getLocalDependencyVersion(packageJson, depName, versionSpec);
                        dependencies.push({
                    ...
                    if (exists) {
                        ...
                        if (packageJsonExists) {
                            ...
                            dependencies.push({
                                id: `${identifier}@${version}`,
                                requireId: `${identifier}@${requireVersion}`,
                                entry: isDirectory ? (0, npm_1.tryResolvePackage)(entry, dir) : entry,
                                name: identifier,
                                ref: `${assetName}.js`,
                                type: 'local',
                            });
