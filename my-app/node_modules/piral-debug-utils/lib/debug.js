...
function installPiralDebug(options) {
    const { getGlobalState, getExtensions, getDependencies, getRoutes, getPilets, fireEvent, integrate, removePilet, updatePilet, addPilet, navigate, customSettings = {}, } = options;
    const events = [];
    ...
    const settings = Object.assign(Object.assign({}, customSettings), { viewState: {
            ...
            value: state_1.initialSettings.clearConsole,
            type: 'boolean',
            ...
            value: state_1.initialSettings.persistSettings,
            type: 'boolean',
