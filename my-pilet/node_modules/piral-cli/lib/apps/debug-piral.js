...
function debugPiral(baseDir = process.cwd(), options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const serverRef = yield (0, common_1.watcherTask)((watcherContext) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield ((_d = hooks.beforeOnline) === null || _d === void 0 ? void 0 : _d.call(hooks, { krasServer, krasConfig, open, port, publicUrl }));
            yield krasServer.start();
            (0, common_1.openBrowser)(open, port, publicUrl, !!krasConfig.ssl);
            yield ((_e = hooks.afterOnline) === null || _e === void 0 ? void 0 : _e.call(hooks, { krasServer, krasConfig, open, port, publicUrl }));
